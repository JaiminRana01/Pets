...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void savePet() {
        ...
        if (mCurrentPetUri == null) {
            ...
            /**
             * otherwise this is an exiting pet, so update the pet with content URI: mCurrentUri
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                /**If pet has'nt changed, continue with navigating up to parent activity which is the {@link CatalogActivity}*/
                if (!mPetHasChanged) {
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int breeColumnIndex = cursor.getColumnIndex(PetEntry.COLUMN_PET_BREED);
     ...
     *
     * @param discardButtonClickListener is the click listener for what to do when user
     *                                   confirms that they want to discard their changes.
     */
    ...
    private void showDeleteConfirmationDialog() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle(getString(R.string.delete_dialog_msg));
        ...
        builder.setNegativeButton(getString(R.string.cancel), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                //when user clicks on cancel button dismiss the dialog and continue editing.
                if (dialog != null) {
                    dialog.dismiss();
                }
            }
    ...
    //delete pet method for deleting pets from database
    private void deletePet() {
        //only perform the delete if this is an exiting pet.
        if (mCurrentPetUri != null) {
